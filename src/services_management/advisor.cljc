(ns services-management.advisor
  "ServicesAdvisor — proposes a services-management operation
  (coordinate a client task, report on service quality, clear a
  service-quality failure, approve a client-contract exception) for a
  registered client. The advisor is swappable: `mock-advisor`
  ...
  of client provenance or quality-failure/contract-exception risk;
  `services-management.governor` is the independent system that
  decides whether the proposal may proceed, per the itonami actor
  pattern.

  A proposal is a map:
    {:op :coordinate|:report|:clear-quality-failure|:approve-contract-exception
...
(def ^:private system-prompt
  "You are a services-management advisor. Given a services operation
